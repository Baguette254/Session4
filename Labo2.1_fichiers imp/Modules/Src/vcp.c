...
int8_t VCP_SendStringBlocking(const char *str)
{
    ...
    uint8_t r = uart_vcp_write_blocking((uint8_t*)str, len, VCP_TX_TIMEOUT_MS);
...
/*//Première signature
void VCP_SendHello(void)
{
    char msg[] = "Hello from STM32\r\n";
    uart_vcp_write((uint8_t*)msg, strlen(msg));
}
*/
